...
# manually updating the package registry
RUN apt update
# installing `libpq-dev` a dependency for `diesel_cli` (-y automatically agrees to install so it can run on docker build)
