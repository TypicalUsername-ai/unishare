...
const ExploreSearch = ({ onSave, user = {} }) => {
    ...
    const handleSave = async () => {
        ...
        const response = await fetch(                               //
            ...
            {                                                       //      Probably wrong api structure, Mateusz will need to review and lmk to what to change it
                method: 'POST',                                     //      tried looking at backend but I am so fucking lost there man idk
